...
class Home_dawn extends StatelessWidget {
  const Home_dawn({super.key});
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      home: Scaffold(
        appBar: AppBar(
          backgroundColor: Color(0xFFFF718CBF), // AppBar 배경색 변경
          title: Text(''),
          actions: [
            IconButton(
              icon: Icon(
        ...
        body: Stack(
          children: [
            Container(
              color: Color(0xFFFF718CBF), // FFDE97 색상의 배경
              child: Center(
                child: Column(
                    ...
                    GestureDetector(
                      onTap: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => FriendDawn()), // friend_morning 파일의 화면으로 이동
                        );
                      },
                      child: Container(
                        width: 200, // 원의 너비
