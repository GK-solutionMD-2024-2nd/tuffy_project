...
class FriendMdawn extends StatelessWidget {
  @override
    ...
    return MaterialApp(
      home: Scaffold(
        appBar: AppBar(
          ...
          title: Text('누구에게 노크할건가요?', style: TextStyle(color: Colors.black)),
          leading: IconButton(
            icon: Icon(Icons.arrow_back, color: Color(0xFFFFAC48B)),
            onPressed: () {
                          ...
                          GestureDetector(
                            onTap: () {
                              Navigator.push(
                                context,
                                MaterialPageRoute(
                                  builder: (context) => KnockMdawn(friendName: friendNames[index]), // 클릭한 이름을 전달
                                ),
                              );
                            },
                            child: Align(
